...
export class EditProjectPage extends React.Component<IEditProjectPageProps> {
  public render(): JSX.Element {
    ...
    return (
      <EditTemplate mode={Mode.Edit} onDelete={undefined} onSave={undefined}>
        <Form.Field>
        ...
        <Form.Group widths="equal">
          <Form.Field>
            {this.select(
              'Status',
              itemProjectMode,
              newProject.projectStatutId,
              onChangeProperty('projectStatutId')
            )}
          </Form.Field>
          <Form.Field>
            {this.select(
              'Mode',
              itemProjectStatus,
              newProject.projectModeId,
              onChangeProperty('projectModeId')
            )}
          </Form.Field>
        </Form.Group>
        <Form.Field>
          {this.toggle(
            'enable over run',
            newProject.enableOverRun,
            onChangeProperty('enableOverRun')
          )}
        </Form.Field>
      </EditTemplate>
    );
